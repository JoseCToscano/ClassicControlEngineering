...
for x in range(0,len(testing_points)):
    ...
    if (((angle_G_evaluated_at_testpoint/180)%2)!= 0 and (angle_G_evaluated_at_testpoint%180 == 0)):
        ...
        error_ss = abs(1/(1+lead_at_0*plant_at_0*value_of_K_lead_controller))
        
        print(lead_at_0,plant_at_0, value_of_K_lead_controller)
...
pdf.output('HomeWork_LeadControler_4.pdf', 'F')
